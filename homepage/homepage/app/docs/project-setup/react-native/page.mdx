...
<CodeGroup>
    ```bash npx create-expo-app -e with-router-tailwind my-jazz-app cd
    my-jazz-app npx expo prebuild ```
</CodeGroup>
...
<CodeGroup>
    ```ts config.resolver.unstable_enablePackageExports = true ```
</CodeGroup>
...
<CodeGroup>
    ```ts import "./polyfills"; import {registerRootComponent} from "expo";
    import App from "./src/App"; registerRootComponent(App); ```
</CodeGroup>
