...
function App() {
    ...
    const createIssue = () => {
        const newIssue = Issue.create(
            {
                title: "Acquire getaway car",
                description: "The goods won't move themselves, will they?",
                estimate: 5,
                status: "backlog",
            },
            { owner: me }
...
<div className="p-3 md:-mx-3 rounded border border-stone-100 dark:border-stone-900 bg-white dark:bg-black not-prose">
    <div className="grid grid-cols-6 text-sm border-r border-b [&>*]:p-2 [&>*]:border-l [&>*]:border-t">
        <h2>Acquire getaway car</h2>
        <p className="col-span-3">The goods won't move themselves, will they?</p>
        <p>Estimate: 5</p>
        <p>Status: backlog</p>
    </div>
</div>
...
<div className="p-3 md:-mx-3 rounded border border-stone-100 dark:border-stone-900 bg-white dark:bg-black not-prose">
    <div className="grid grid-cols-6 text-sm border-r border-b [&>*]:p-2 [&>*]:border-l [&>*]:border-t">
        <input type="text" value={"Acquire getaway car"}/>
        <input type="text" className="col-span-3" value={"The goods won't move themselves, will they?"}/>
