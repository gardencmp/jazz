...
<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-0 -mx-4 md:-mx-6">
<ChatCodeExample className="lg:col-span-2"/>

<ResponsiveIframe
  src="https://chat.jazz.tools"
  localSrc="http://localhost:5173"
  className="rounded-sm shadow-sm overflow-hidden min-h-[50vh]"
/>
</div>
</div>
