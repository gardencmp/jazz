...
import { Nav, NavLink } from "gcmp-design-system/src/components/molecules";
    ...
    <html lang="en">
      <body
        className={clsx(
          ...
          pragmata.variable,
          inter.variable,
          // bg-stone-50 dark:bg-stone-950 — set in globals w/ other defaults
          // overflow-x-hidden — not needed if the layout is correct
      ...
      >
        ...
        >
          ...
          <main
            className={clsx(
              // "flex min-h-screen flex-col p-8 max-w-[80rem] w-full"
              // [&_*]:scroll-mt-[6rem] — this is part of the prose typography, needs to be colocated
              "container",
            )}
          >
            {children}
          ...
          <footer className="flex z-10 mt-10 min-h-[15rem] -mb-20 bg-stone-100 dark:bg-stone-900 text-stone-600 dark:text-stone-400 w-full justify-center">
            <div className="p-8 max-w-[80rem] w-full grid grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-8 max-sm:mb-12">
              ...
              {/* <div className="flex flex-col col-span-3 gap-2 text-sm md:col-start-2 lg:col-start-auto">
                                Sign up for updates:
                                <Newsletter />
                            </div> */}
            </div>
