...
function Step({ step, description, children } : { step: number; description: string, children: React.ReactNode }) {
    return (
      <div className={clsx(
...
export function HowItWorks() {
    ...
    return (
      <div className="grid gap-8">
          ...
          <GappedGrid>
              <Step step={1} description="Define your schema using Collaborative Values &mdash; your new building blocks.">
                  <Code fileName="schema.ts">
                      <CodeStepOne />
                  </Code>
              </Step>
              <Step step={2} description="Create a Collaborative Value, and it will be synced and persisted automatically.">
                  <Code fileName="sendMessage.ts">
                      <CodeStepTwo />
                  </Code>
              </Step>
              <Step step={3} description="Read your data like simple local state. The UI updates instantly across all devices and users. 🎉">
