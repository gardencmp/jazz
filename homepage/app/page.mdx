...
**&ldquo;Collaborative data&rdquo;** &mdash; giving you **distributed state** with **secure permissions built-in.**

This lets you **offer features out-of-the-box** that used to take years to build:
...
<GridFeature icon={<UsersIcon/>}>Collaboration, teams & orgs</GridFeature>
<GridFeature icon={<FileLock2Icon/>}>Fine-grained permissions & sharing</GridFeature>
<GridFeature icon={<WorkflowIcon />}>On-demand granular data‑fetching</GridFeature>
<GridFeature icon={<UploadCloudIcon />}>Cloud data storage & geographic caching</GridFeature>
<GridFeature icon={<HardDriveDownloadIcon />}>Offline support & local-first data storage</GridFeature>
<GridFeature icon={<PlaneIcon />}>Graceful handling of bad connections</GridFeature>
