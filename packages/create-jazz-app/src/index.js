...
import ora from "ora";
import { frameworkToAuthExamples } from "./config.js";
const program = new Command();
// Cool gradient for the Jazz brand
const jazzGradient = gradient(["#FF4D4D", "#FF9900", "#FFD700"]);
async function scaffoldProject({ starter, projectName, packageManager }) {
  console.log(chalk.blue("Jazz App Creator\n"));
...
program
  .description(chalk.blue("CLI to scaffold Jazz starter projects"))
